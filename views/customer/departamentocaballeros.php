...
<div class="grid-block" style="background-image: url('img/hombres.jpg'); ">
    <div class="banner banner-cover">
        <div class="banner-container ">
            <marquee SCROLLAMOUNT=30>
                <h1 class="title-cover">HOMBRES </h1>
            </marquee>
        </div>
    </div>
</div>
<div class="container">
    ...
    <div class="row">
        <?php
        $sentencia = $pdo->prepare("SELECT * from prenda WHERE id_Departamento=2");
        $sentencia->execute();
        ...
        <?php foreach ($listaProductos as $producto) {
            ...
            echo '<div class="card">';
            echo '<img title="Titulo del producto" height="317px" class="card-img.top" src="img/productos/' . $producto['img_prenda'] . '">';
        ?>
            <div class="card-body" <h3><?php echo $producto['nombre']; ?></h3>
                ...
                <form action="" method="post">
                    ...
                    <button class="btn btn--mini-rounded" name="btnAccion" value="Agregar" type="submit">
