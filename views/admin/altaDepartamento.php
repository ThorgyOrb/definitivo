					...
					<div class="columns">
						...
						<div class="column is-half">
							<form action="<?php echo $_SERVER['PHP_SELF']; ?>" METHOD="post">
								...
								<input type="text" name="nombre_Departamento" placeholder="Departamento" class="form-control" aria-label="Amount (to the nearest dollar)" require>
								
								</div>

								
								<center><button type="submit" name="enviarAD" class="btn btn-default btn-primary">Eviar datos</button><br></center>
<?php
include("configtienda.php");
