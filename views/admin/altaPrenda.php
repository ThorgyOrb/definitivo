				...
				<div class="column">
					...
					<div class="container">
						<div class="columns">
							...
							<div class="column is-half">
								<form action="enviarprenda.php" enctype="multipart/form-data" METHOD="post">
									<center>
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="nombre" placeholder="Nombre" class="form-control" require>
									...
									<?php
									$conexion = mysqli_connect("localhost", "id18781494_root", "QTwiVg()bx#Jq1S|") or die("error en la conexion");
									if ($conexion) {
										mysqli_select_db($conexion, "id18781494_tiendaropa") or die("ERROR bd");
										$query = "SELECT * FROM marca;";
										$registros = mysqli_query($conexion, $query) or die("error query ");
									...
									<center><button type="submit" name="" class="btn btn-default btn-primary">Guardar</button><br></center>
								</form>
							</div>
						</div>
					</div>
