...
//echo '<script> alert("el id es: '.$_GET['marca'].'"); </script>';
$consulta=consultarmarca($_GET['marca']);
	function consultarmarca($marca){
		...
		if($conexion)
		{
			...
			$mostrar="SELECT * FROM marca WHERE id_Marca ='".$marca."';";
            ...
            <div class="column">
				...
				<div class="container">
					<div class="columns">
						...
						<div class="column is-half">
							<form action="actmarca.php" METHOD="post">
								<center><h2 class="is-size-4">Tabla Marca</h2></center>
								<br>
								
                                <div class="input-group mb-3">
								<span class="input-group-text">ID: </span>
								<input type="entero" name="id_Marca" style="pointer-events:none;" value="<?php echo $consulta[0]; ?>" class="form-control" >
								...
								<input type="text" name="nombre_marca" placeholder="Nombre de la marca" class="form-control" value="<?php echo $consulta[1]; ?>" require>
								
								</div>

								
								<center><button type="submit" name="" class="btn btn-default btn-primary">Eviar datos</button><br></center>
<?php
/*include("configtienda.php");
