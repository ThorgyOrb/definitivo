                ...
                <div class="container">
                    ...
                    if ($conexion) {
                        ...
                        while ($tupla = mysqli_fetch_array($registros)) //recupera cada registro en la variable tupla, mientras pueda acceder al registro va a imprimir cada uno de estos (tupla se comporta como un arreglo de asociativas)
                        {
                            ...
                            echo "<td>" . $tupla['id_Proveedor'] . "</td>";
                            echo '<td><img src="../../productos/' . $tupla['img_prenda'] . '" alt="" width="150"></td>';
                            echo '<td><a href="mod_prenda.php?ropa=' . $tupla['id_Prenda'] . '"  class="btn btn-default btn-primary">Editar</a></td></tr>';
                            echo '</center>';
                        }
