...
//echo '<script> alert("el id es: '.$_GET['pro'].'"); </script>';
	
	$consulta=consultarpro($_GET['pro']);
	function consultarpro($proveedor){
		$conexion = mysqli_connect("localhost","root","") or die ("error en la conexion");
		if($conexion)
		{
			mysqli_select_db($conexion,"tiendaropa") or die("ERROR bd");
			$mostrar="SELECT * FROM proveedor WHERE id_Proveedor ='".$proveedor."';";
				...
				<div class="container">
					<div class="columns">
						<div class="column is-half">
							<br><br>
							<img src="img/proveedor.jpg" alt="">
						</div>
						<div class="column is-half">
							<form action="actproveedor.php" METHOD="POST">
								<center><h2 class="is-size-4">Tabla Proveedor</h2></center>
								<br>
								<div class="input-group mb-3">
								<span class="input-group-text">ID: </span>
								<input type="entero" name="id_Proveedor" style="pointer-events:none;" value="<?php echo $consulta[0]; ?>" class="form-control" >
								
								<div class="input-group mb-3">
								<span class="input-group-text">Proveedor: </span>
								<input type="text" name="nombre_Proveedor" placeholder="Proveedor" class="form-control" value="<?php echo $consulta[1]; ?>" require>
