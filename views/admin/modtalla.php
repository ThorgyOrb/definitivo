...
//echo '<script> alert("el id es: '.$_GET['talla'].'"); </script>';
$consulta=consultartalla($_GET['talla']);
function consultartalla($talla){
    $conexion = mysqli_connect("localhost","root","") or die ("error en la conexion");
    if($conexion)
    {
        mysqli_select_db($conexion,"tiendaropa") or die("ERROR bd");
        $mostrar="SELECT * FROM talla WHERE id_Talla ='".$talla."';";
				...
				<div class="container">
					<div class="columns">
						<div class="column is-half">
							<br><br>
							<img src="img/tallas.jpg" alt="">
						</div>
						<div class="column is-half">
							<form action="acttalla.php" METHOD="post">
								<center><h2 class="is-size-4">Tabla Talla</h2></center>
								<br>
                                <div class="input-group mb-3">
								<span class="input-group-text">ID: </span>
								<input type="entero" name="id_Talla" style="pointer-events:none;" value="<?php echo $consulta[0]; ?>" class="form-control" >
								
								</div>   

								<div class="input-group mb-3">
								<span class="input-group-text">ID: </span>
								<input type="entero" name="numero_Talla"  value="<?php echo $consulta[1]; ?>" class="form-control" >
...
if(isset($_POST['enviarAT'])){
	if( isset($_POST['numero_Talla']) && $_POST['numero_Talla']!="")
	{
			...
			if($conexion)
			{
				...
				//inserto la talla
				$query="INSERT INTO talla(numero_Talla) VALUES ('$numero_Talla')";
