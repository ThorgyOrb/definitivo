...
<body>
	...
	<div class="container">
        <div class="columns">
            ...
            <div class="column is-half">
                <h3 class="has-text-weight-bold">Administración de la Base de Datos de ONBOU</h3>
                <p>Como administrador en esta sección puedes hacer de Altas, Bajas, Consultas y Modificaciones en las tablas de "Prenda", "Marca", "Talla", "Departamento" y "Provedor", para ello selecciona una opción del menú de arriba. </p>
            </div>
        </div>
    </div>
    <!-- footer -->
