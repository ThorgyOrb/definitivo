				...
				<div class="container">
					<div class="columns">
						<div class="column is-half">
							<br><br>
							<img src="img/departamentos.jpg" alt="">
						</div>
						<div class="column is-half">
							<form action="actdepa.php" METHOD="post">
								<center><h2 class="is-size-4">Tabla Departamento</h2></center>
								<br>
								<div class="input-group mb-3">
								<span class="input-group-text">ID: </span>
								<input type="entero" name="id_Departamento" style="pointer-events:none;" value="<?php echo $consulta[0]; ?>" class="form-control" >
								
								</div> 
								<div class="input-group mb-3">
								<span class="input-group-text">Departamento: </span>
								<input type="text" name="nombre_Departamento" placeholder="Departamento" class="form-control" value="<?php echo $consulta[1]; ?>" require>
								
								</div>

								
								<center><button type="submit"  class="btn btn-default btn-primary">Eviar datos</button><br></center>
<?php
/*include("configtienda.php");
...
if(isset($_POST['enviarAD'])){
	if( isset($_POST['nombre_Departamento']) && $_POST['nombre_Departamento']!="")
	{
			...
			if($conexion)
			{
				...
				//inserto la departamento
				$query="INSERT INTO departamento(nombre_Departamento) VALUES ('$nombre_Departamento')";
